local function uv_workspace_rootdir(bufnr, on_dir)
...
local function set_keymaps()
    ...
    end, { silent = true, desc = "Show all in trouble" })
    ...
    end, { silent = true, desc = "Jump to previous" })
    ...
    vim.keymap.set("n", "K", function()
        vim.lsp.buf.hover({ offset_x = -1, border = "rounded" })
    end, { silent = true })
